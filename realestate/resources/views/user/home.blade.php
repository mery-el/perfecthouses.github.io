    ...
    <div class="header-media">
        <div class="banner-parallax">
            <div class="banner-bg-wrap">
                <div class="banner-inner" style="background-image: url('{{url('assets/images/wallpapers/banner.jpg')}}')"></div>
            </div>
        </div>
        <div class="banner-caption">
            <h1>Welcome To Perfet Houses</h1>
            <h2 class="banner-sub-title">Your perfect choice</h2>
        </div>
